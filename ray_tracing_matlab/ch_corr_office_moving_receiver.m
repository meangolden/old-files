...
write = "yes"
fc = 2.4e9;
method = "image"; % "sbr" or "image". Latter higher location precision
...
rx1 = rxsite("cartesian", ...
    "Antenna",rxAntenna, ...
    "AntennaPosition",[1.5; 1.5 ;.75], ...
    "AntennaAngle",[0;90]);

rx2 = rxsite("cartesian", ...
    "Antenna",rxAntenna, ...
    "AntennaPosition",[1.5 + d; 1.5; .75], ...
    "AntennaAngle",[0;90]);
...
pm = propagationModel("raytracing", ...
    ...
    "Method",method, ...   # sbr:shooting and bouncing rays
...
if write == "yes"
    newData = {fc/1e6, maxNumReflections, "N/A",material, length(txs),...
